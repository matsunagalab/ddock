...
the correct answer. Measured over 8000 random orientations:
...
At equal point count the Hopf grid cuts the worst case by 35\%; the tail
improves far more than the mean. $n_{\text{side}}=3$ corresponds to
$\Delta \approx 17^\circ$, matching the paper's ``1800 orientations at
$\Delta = 20^\circ$''.
...
$h = 1.2$~\AA, top-2000 search output, \textbf{nothing injected into the
candidate set and no native-informed rotations}. An earlier revision of this
note quoted higher numbers measured with a $25^\circ$ cone around the native
orientation $q^\ast$ mixed into the rotation set; that leaks the answer and is
excluded here.
...
\begin{tabular}{lrrrrr}
  ...
  full PSC, uniform rotations            & $58\%$   & $0.398$ & $8\%$ & $17\%$ & $42\%$ \\
